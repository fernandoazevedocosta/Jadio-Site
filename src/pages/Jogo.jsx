...
export function Jogo() {
  return (
    <main className="flex flex-col items-center min-h-screen bg-white px-4 sm:px-8 lg:px-20 py-10 dark:bg-[rgb(2,8,23)]">
      ...
      <h2 className="text-2xl font-semibold mt-10 mb-6">Como Jogar</h2>
      ...
      <button className="text-2xl mt-10 mb-20 px-8 py-3 border-2 border-cyan-500 text-cyan-500 font-semibold rounded-xl hover:bg-cyan-500 hover:text-white transition">
        Download Game
      </button>
    </main>
  )
