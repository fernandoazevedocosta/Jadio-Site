  ...
  return (
    <main className="flex flex-col items-center min-h-screen bg-white px-4 sm:px-8 lg:px-20 py-10 dark:bg-[rgb(2,8,23)]">
      ...
      <div className="flex flex-col items-center text-center mt-10">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold dark:text-white">EcoShawk</h1>
      ...
      <h2 className="text-xl sm:text-2xl font-semibold mt-10 mb-6">Como Jogar</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full max-w-4xl">
        ...
        <div className="flex flex-col items-center bg-white rounded-2xl p-6 shadow hover:shadow-lg transition dark:bg-[rgb(35,41,55)]">
          ...
          <h3 className="font-semibold text-lg dark:text-white">Como Funciona</h3>
        ...
        <div className="flex flex-col items-center bg-white rounded-2xl p-6 shadow hover:shadow-lg transition dark:bg-[rgb(35,41,55)]">
          ...
          <h3 className="font-semibold text-lg dark:text-white">Personagem</h3>
          <p className="text-gray-600 text-center mt-1">
        ...
        <div className="flex flex-col items-center bg-white rounded-2xl p-6 shadow hover:shadow-lg transition dark:bg-[rgb(35,41,55)]">
          ...
          <h3 className="font-semibold text-lg dark:text-white">Objetivo</h3>
          <p className="text-gray-600 text-center mt-1">
