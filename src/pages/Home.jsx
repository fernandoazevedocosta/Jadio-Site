...
export function Home() {
  return (
    <main className="flex flex-col items-center px-6 sm:px-10 md:px-16 lg:px-24 xl:px-32 py-10 bg-white min-h-screen text-gray-800 dark:bg-[rgb(2,8,23)]">
      ...
      <Link
        to="/instrucoes"
        className="w-full sm:w-[307px] h-[70px] sm:h-[96px] flex items-center justify-center rounded-[30px] sm:rounded-[41px] bg-gradient-to-r from-blue-600 to-blue-400 text-white font-semibold hover:opacity-90 transition"
      >
        Como Funciona
      ...
      <Link
        to="/sobre"
        className="w-full sm:w-[307px] h-[70px] sm:h-[96px] flex items-center justify-center rounded-[30px] sm:rounded-[41px] border-4 border-blue-400 text-blue-500 font-semibold hover:bg-blue-50 transition"
      >
        Conheça o Projeto
      </Link>
    </div>
      ...
      <section className="max-w-3xl w-full mt-20 mb-24 px-8 ">
        <div className="p-12 border shadow-lg rounded-3xl bg-white text-center dark:bg-[rgb(35,41,55)]">
          ...
          <Link
            to="/jogo"
            className="mt-8 inline-block bg-gradient-to-r from-purple-600 to-pink-500 text-white font-bold py-4 px-20 rounded-3xl hover:opacity-90 transition"
          >
            Jogar
          </Link>
        </div>
