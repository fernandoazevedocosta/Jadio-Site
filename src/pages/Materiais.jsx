...
export function Materiais() {
  return (
    <main className="flex flex-col items-center min-h-screen bg-white px-6 py-10 text-center dark:bg-[rgb(2,8,23)]">
      <h1 className="font-bold mb-4 dark:text-white">Materias e Custos</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-12 w-full max-w-4xl place-items-center">
        ...
        <div className="bg-white rounded-2xl shadow p-6 flex flex-col w-full h-full dark:bg-[rgb(35,41,55)]">
          ...
          <h2 className="font-semibold dark:text-white">Componentes Eletrônicos</h2>
        ...
        <div className="bg-white rounded-2xl shadow p-6 flex flex-col w-full h-full dark:bg-[rgb(35,41,55)]">
          ...
          <h2 className="font-semibold dark:text-white">Sistema de Energia</h2>
        ...
        <div className="bg-white rounded-2xl shadow p-6 flex flex-col w-full h-full dark:bg-[rgb(35,41,55)]">
          ...
          <h2 className="font-semibold dark:text-white">Sistema Mecânico</h2>
        ...
        <div className="bg-white rounded-2xl shadow p-6 flex flex-col w-full h-full dark:bg-[rgb(35,41,55)]">
          ...
          <h2 className="font-semibold dark:text-white">Materiais Estruturais</h2>
      ...
      <div className="bg-white rounded-2xl shadow p-8 flex flex-col items-center mt-12 w-full max-w-2xl mb-24 dark:bg-[rgb(35,41,55)]">
        ...
        <h3 className="font-bold dark:text-white">Custo Total do Protótipo</h3>
        <h4 className="text-cyan-500 font-bold mt-2">R$500</h4>
      </div>
    </main>
  )
}
